 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_dw_tanks']['title_legend'] = "Stammdaten";
$GLOBALS['TL_LANG']['tl_dw_tanks']['details_legend'] = "Details zum Tauchgerät";
$GLOBALS['TL_LANG']['tl_dw_tanks']['notes_legend'] = "Notizen";
$GLOBALS['TL_LANG']['tl_dw_tanks']['publish_legend'] ="Veröffentlichen";

/**
* Global operations
*/
$GLOBALS['TL_LANG']['tl_dw_tanks']['new'] = ["Neu", "Ein neues Element anlegen"];

/**
 * Operations
 */
$GLOBALS['TL_LANG']['tl_dw_tanks']['edit'] = "Datensatz mit ID: %s bearbeiten";
$GLOBALS['TL_LANG']['tl_dw_tanks']['copy'] = "Datensatz mit ID: %s kopieren";
$GLOBALS['TL_LANG']['tl_dw_tanks']['delete'] = "Datensatz mit ID: %s löschen";
$GLOBALS['TL_LANG']['tl_dw_tanks']['show'] = "Datensatz mit ID: %s ansehen";
$GLOBALS['TL_LANG']['tl_dw_tanks']['toggle'] = "Datensatz mit ID: %s veröffentlichen";
...
$GLOBALS['TL_LANG']['tl_dw_tanks']['size'] = ["Größe", "Bitte die Flaschengröße auswählen."];
$GLOBALS['TL_LANG']['tl_dw_tanks']['member'] = ["Eigentümer", "Eigentümer der Flasche."];
$GLOBALS['TL_LANG']['tl_dw_tanks']['addSubpalette'] = ["Bemerkungen eingeben", "Bemerkungen zum Tauchgerät erfassen."];
 ...
 * References
 */
$GLOBALS['TL_LANG']['tl_dw_tanks']['sizes'] = [
    '2' => '2 L',
    '3' => '3 L',
    '5' => '5 L',
    '7' => '7 L',
 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_dw_tanks']['createInvoiceButton'] = "Rechnung erstellen";
