...
$GLOBALS['TL_LANG']['tl_calendar_events']['addArticleInfo'] = ["TÜV-Preise", "Preisliste für den TÜV-Termin erfassen"];

$GLOBALS['TL_LANG']['tl_calendar_events']['is_tuv_appointment'] = ["TÜV-Termin", "Dieser Event ein TÜV-Termin?"];
$GLOBALS['TL_LANG']['tl_calendar_events']['vendorName'] = ["Firma", "Firmenname des Prüfungunternehmens"];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['checkArticles'] = ["TÜV-Preisliste", "Geben Sie die Inventarnummer ein"];
$GLOBALS['TL_LANG']['tl_calendar_events']['articleName'] = ["Artikel", "Geben Sie die Inventarnummer ein"];
$GLOBALS['TL_LANG']['tl_calendar_events']['articleNotes'] = ["Beschreibung", "Geben Sie die Inventarnummer ein"];
$GLOBALS['TL_LANG']['tl_calendar_events']['articlePriceNetto'] = ["Preis netto", "Geben Sie die Inventarnummer ein"];
$GLOBALS['TL_LANG']['tl_calendar_events']['articlePriceBrutto'] = ["Preis brutto", "Geben Sie die Inventarnummer ein"];
